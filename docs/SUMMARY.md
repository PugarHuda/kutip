...
This file is the GitBook sidebar. GitBook and similar static-site
generators (Honkit, mdBook) read SUMMARY.md to build the navigation
tree. GitHub renders it as a normal markdown file.
...
* [Plan & milestones](plan-10-days.md)
